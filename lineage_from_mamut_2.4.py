...
# Tool to generate cell IDs and cell generation from Mamut-xml files. 
# a new mamut-file is created where this information is added to the spot attributes. 


# Version info: 
# New in version 1.9:
# overlap in cell list removed (Spots can no longer be end spot of one cell and 
# 	start spot of another cell at the same time).

# !!!!! TO DO: MODIFY ALGORITHM TO ALLOW CELL FUSION
...
start_spot_gens = []
def get_start_gens (start_spots):
